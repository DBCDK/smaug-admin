  ...
  return (
    <div className="clientform">
      ...
      <form method="post" onSubmit={onSubmit}>
        ...
        <AdgangsplatformForm jsonConfig={jsonConfig} updateJEditor={updateJEditor} toggleJson={toggleJson} />

        <JEditor name="config" json={jsonConfig} setErrorState={setErrorState} isVisible={showEditor()}/>
